...
public class SimulationObject {
    ...
    public void setPosition(Vector2 pos) {
        ...
        this.simulationObjectBodyDef.position.set(new Vec2((float) (position.x / SimulationManager.getInstance().getScale()),
                (float) (position.y / SimulationManager.getInstance().getScale())));
    }
