...
public class PhysiplayController {
    ...
    // scroll value starts at 10, with a minimum of 0
    private double scrollValue = 10.0;
    ...
    private void handleScrollEvent(ScrollEvent event) {
        ...
        scrollValue += deltaY * scrollSensitivity;
        scrollValue = Math.max(4.0, scrollValue);
        SimulationManager.getInstance().setScale((float) scrollValue);
        System.out.println("Scroll Value: " + scrollValue + ", New Scale: " + SimulationManager.getInstance().getScale());
        event.consume();
    }

    private void setUpTimer() {//why is this not getting used lol
